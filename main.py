...
def func(filenametemp):
    ...
    # 텍스트 찾는 AI
    text_detect_result = reader.detect(filenametemp, min_size=1, text_threshold=0.1, low_text=0.4, link_threshold=0.1,
    ...
    for i in result:
        ...
        if (img.size[0]*img.size[1])//1024>(i[0][1][0]-i[0][0][0])*(i[0][2][1]-i[0][1][1]):
